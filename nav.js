...
(function () {
  ...
  const NAV = [
    ...
    },
    {
      ...
      open: false,
      links: [
        { text: 'Project Hermes',        href: '/project-hermes/' },
        { text: 'Refrigeration',         href: '/project-hermes/tools/refrigeration.html', sub: true },
        { text: 'Airflow',               href: '/project-hermes/tools/airflow.html',       sub: true },
        { text: 'Heat',                  href: '/project-hermes/tools/heat.html',          sub: true },
        { text: 'Electrical',            href: '/project-hermes/tools/electrical.html',    sub: true },
        { text: 'Motors',                href: '/project-hermes/tools/motors.html',        sub: true },
        { text: '— Calculators —',       href: null, sub: true, divider: true },
        { text: 'Belt Deflection',       href: '/project-hermes/tools/calculators/belt-deflection.html', sub: true },
        { text: 'Belt Length',           href: '/project-hermes/tools/calculators/belt-length.html',       sub: true },
        { text: 'Breaker Sizing',        href: '/project-hermes/tools/calculators/breaker-sizing.html',    sub: true },
        { text: 'Capacitor Sizing',      href: '/project-hermes/tools/calculators/capacitor-sizing.html',  sub: true },
        { text: 'CFM per Ton',           href: '/project-hermes/tools/calculators/cfm-per-ton.html',       sub: true },
        { text: 'Combustion Air',        href: '/project-hermes/tools/calculators/combustion-air.html',    sub: true },
        { text: 'Condensate Drain',      href: '/project-hermes/tools/calculators/condensate-drain.html',  sub: true },
        { text: 'Duct Sizing',           href: '/project-hermes/tools/calculators/duct-sizing.html',       sub: true },
        { text: 'Electrical Cost',       href: '/project-hermes/tools/calculators/electrical-cost.html',   sub: true },
        { text: 'Enthalpy',              href: '/project-hermes/tools/calculators/enthalpy.html',          sub: true },
        { text: 'Gas Pipe',              href: '/project-hermes/tools/calculators/gas-pipe.html',          sub: true },
        { text: 'Load Calc',             href: '/project-hermes/tools/calculators/load-calc.html',         sub: true },
        { text: 'Long Lineset',          href: '/project-hermes/tools/calculators/long-lineset.html',      sub: true },
        { text: 'MCA / MOCP',            href: '/project-hermes/tools/calculators/mca-mocp.html',          sub: true },
        { text: 'Motor Convert',         href: '/project-hermes/tools/calculators/motor-convert.html',     sub: true },
        { text: 'Motor Start Controls',  href: '/project-hermes/tools/calculators/motor-start-controls.html', sub: true },
        { text: "Ohm's Law",             href: '/project-hermes/tools/calculators/ohms-law.html',          sub: true },
        { text: 'Pressure Convert',      href: '/project-hermes/tools/calculators/pressure-convert.html',  sub: true },
        { text: 'Pump Sizing',           href: '/project-hermes/tools/calculators/system-head.html',       sub: true },
        { text: 'Refrigerant Charge',    href: '/project-hermes/tools/calculators/refrigerant-charge.html',sub: true },
        { text: 'Temp Convert',          href: '/project-hermes/tools/calculators/temp-convert.html',      sub: true },
        { text: 'Ventilation Sizing',    href: '/project-hermes/tools/calculators/ventilation-sizing.html', sub: true },
        { text: 'Wire Sizing',           href: '/project-hermes/tools/calculators/wire-sizing.html',       sub: true },
      ]
    },
    {
      label: 'Samsung',
